...
int main(int argc, char* argv[])
{
  ...
  // for loop to do the calculation over and over for a large data set
  for (int i=1; i <=10;i++){

    std::string number = std::to_string(i);
  if (my_rank == 0 && argc > 1) {
    outfilename=argv[1];
    std::string newname = outfilename;
  ...
  n_spins = 20; mcs = 1000000;  initial_temp = 2.4; final_temp = 2.4; temp_step =0.02;
  /*
